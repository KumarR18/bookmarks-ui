...
import { g as getAugmentedNamespace, c as createCommonjsModule, a as getDefaultExportFromCjs, B as BookMarkActionTypes, s as store } from './index-35b42073.js';
...
const index = /*@__PURE__*/getDefaultExportFromCjs(reduxDevtoolsExtension);
...
const reducer = (state = initialState, action) => {
  ...
  switch (type) {
    ...
    case BookMarkActionTypes.ADD_BOOKMARK:
      return Object.assign(Object.assign({}, state), { loading: payload, currentBookmark: bookmark });
    ...
    case BookMarkActionTypes.BOOKMARKS_DOWNLOAD_OK:
      return Object.assign(Object.assign({}, state), { loading: false, error: undefined, bookmarks: payload });
    case BookMarkActionTypes.RETRIEVE_BOOKMARK_DELETE:
      return Object.assign(Object.assign({}, state), { currentBookmark: payload });
    case BookMarkActionTypes.BOOKMARK_DELETED_OK:
      return Object.assign(Object.assign({}, state), { bookmarks: bookmarks === null || bookmarks === void 0 ? void 0 : bookmarks.filter((bookmark) => bookmark.id !== currentBookmark.id), currentBookmark: undefined });
    default:
      return state;
  }
};
...
const configureStore = (preloadedState) => createStore(reducers, preloadedState, reduxDevtoolsExtension.composeWithDevTools(applyMiddleware(thunk)));

const appCss = ".appRoot{display:flex;justify-content:center;max-width:1200px;margin:0 auto}.appRoot .mainWrapper{margin:1em 2em 3em 2em;display:flex;justify-content:center}@media only screen and (max-width: 768px){.appRoot{display:flex;flex-direction:column;overflow:hidden}.appRoot .mainWrapper{display:flex;flex-direction:column}}header{text-align:center}";
...
const AppRoot = class {
  ...
  render() {
    return (h("div", null, h("header", null, h("h1", null, "Bookmarks")), h("div", { class: "appRoot" }, h("div", { class: 'mainWrapper' }, h("app-bookmarktable", null), h("app-addbookmark", null)))));
  }
};
AppRoot.style = appCss;
